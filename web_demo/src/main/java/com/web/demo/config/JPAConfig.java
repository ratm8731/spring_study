...
@Configuration
@ComponentScan(basePackages = "com.web.demo")
@EnableTransactionManagement
@EnableJpaRepositories(basePackages = {"com.web.demo.repositories"})
public class JPAConfig {
	...
	public EntityManagerFactory entityManagerFactory() throws IOException {
		...
		factoryBean.setPackagesToScan("com.web.demo.entities");
